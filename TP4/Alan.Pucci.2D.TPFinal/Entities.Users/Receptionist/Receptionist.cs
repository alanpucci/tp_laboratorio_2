...
using Entities.Users.Receptionist;
using Procedure;

namespace Entities
{
    public class Receptionist:User, IReceptionist<Computer>, IUser<Computer>
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public Receptionist(string name, string lastName, string username, string password)
